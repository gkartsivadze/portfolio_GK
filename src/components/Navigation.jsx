...
export default function Navigation({ setContactForm }) {
  ...
  function handleClick(e, link) {
    ...
    return (
        <nav id="navigation">
          <Link onClick={(e) => handleClick(e, 0)} to="/"><svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 512 512" xmlns:v="https://vecta.io/nano"><path fillRule="evenodd" d="M256 64l192 153.6V448H277.333V341.333h-42.667V448H64V217.6L256 64zm0 53.333L106.667 234.667v170.667H192V298.667h128v106.667h85.333V234.667L256 117.333z"/></svg></Link>
          <Link onClick={(e) => handleClick(e, 1)} to="/projects">PROJECTS</Link>
